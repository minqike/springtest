...
public class StatusUtil {
     ...
     * @return
     */
    public static ClientStatus getClientStatus(String projectName,int version,String group,String ipAddress,String startCMD,String[] remark) throws UnknownHostException {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ClientStatus clientStatus = StatusUtil.getClientStatus("testproj", 1, "group", "localhost", "cmd", null);
        System.out.println(clientStatus);
        RuntimeMXBean runtimeMXBean = ManagementFactory.getRuntimeMXBean();
        Runtime runtime = Runtime.getRuntime();

        System.out.println(runtimeMXBean.toString());
